...
| :----------------------------------------------------: | :---------------------------------------------------: |
| ![The web UI: paste an export, tune the style](docs/web-ui.png) | ![Rendered cards ready to post](docs/card-preview.png) |
...
**Docker** (recommended) — one command, then open <http://localhost:3000>:
...
Chat is the sweet spot, but under the hood it's just _records → cards_: map any array of objects — quotes, notes, FAQ items, changelog entries — onto a label + text field and each row becomes a card (see the Quote / Note / News templates).
