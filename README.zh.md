...
把 Slack、ChatGPT、Claude 的原始导出粘进去，json2card 自己认出格式，把对话排成能直接发出去的卡片图 —— 不用定义结构，也不用事后在 Figma 里收拾。品牌色调一次，PNG 就能直接放进博客、Notion 或 16:9 幻灯片。

|                  粘进去、调排版                   |                     出来的成品                     |
| :------------------------------------------------: | :-------------------------------------------------: |
| ![网页界面：粘贴导出内容、调整样式](docs/web-ui.png) | ![排好版、可直接发的卡片](docs/card-preview.png) |
...
[365 开源计划](https://github.com/rockbenben/365opensource) 的第 **#003** 个项目——一个人 + AI，一年 300+ 个开源项目。[提交你的需求 →](https://365.aishort.top/) · [Discord](https://discord.gg/PZTQfJ4GjX) · [Telegram](https://t.me/aishort_top)
